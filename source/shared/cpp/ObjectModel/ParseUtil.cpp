...
namespace AdaptiveSharedNamespace
{
    ...
    std::shared_ptr<BaseActionElement> ParseUtil::GetActionFromJsonValue(std::shared_ptr<ElementParserRegistration> elementParserRegistration,
        std::shared_ptr<ActionParserRegistration> actionParserRegistration,
        std::vector<std::shared_ptr<AdaptiveCardParseWarning>>& warnings, const Json::Value& json)
    {
    ...
    std::shared_ptr<BaseActionElement> ParseUtil::GetSelectAction(std::shared_ptr<ElementParserRegistration> elementParserRegistration,
        std::shared_ptr<ActionParserRegistration> actionParserRegistration,
        std::vector<std::shared_ptr<AdaptiveCardParseWarning>>& warnings, const Json::Value& json,
        AdaptiveCardSchemaKey key, bool isRequired)
    {
